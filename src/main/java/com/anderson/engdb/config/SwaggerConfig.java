package com.anderson.engdb.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.anderson.engdb.resources"))
	...
	private ApiInfo apiInfo() {
		 return new ApiInfo(
		 "API para processo seletivo na Engineering do Brasil",
		 "Desenvolvida por: Anderson Milagre de Freitas",
		 "Versão 1.0",
		 "https://www.udemy.com/terms",
		 new Contact("Anderson Freitas", "https://github.com/mfderson", "mfderson@gmail.com"),
		 "Permitido uso para processo avaliativo",
		 "https://github.com/mfderson",
